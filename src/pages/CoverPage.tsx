...
const CoverPage = () => {
  ...
  const crewProfiles: Record<string, CrewProfile> = {
    ...
    "ben": { description: "Ben creates dotcom PTO model gallery images. Generates images reflecting accurate information with consistent and stable quality.", role: "PTO Image Creator", image: benProfile, detailImage: "/lovable-uploads/ben-detail-image.png", isComingSoon: false, ctaLabel: "Work with Ben", ctaAction: () => window.open("https://ben-twincrew.lovable.app", "_blank") },
    ...
    "milo": { description: "Milo is an eCRM Designer who creates email content based on pre-designed layouts. He helps produce modular email components by customizing text, visuals, and formatting to match brand guidelines for customer communications.", role: "eCRM Designer", image: "/lovable-uploads/milo-profile.png", detailImage: "/lovable-uploads/milo-detail-image.png", isComingSoon: false, ctaLabel: "Work with Milo", ctaAction: () => window.open("https://milo-twincrew.lovable.app", "_blank") },
