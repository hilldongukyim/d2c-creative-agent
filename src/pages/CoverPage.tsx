...
const CoverPage = () => {
  ...
  const crewProfiles: Record<string, CrewProfile> = {
    ...
    "milo": { description: "Milo is an eCRM Designer who creates email content based on pre-designed layouts. He helps produce modular email components by customizing text, visuals, and formatting to match brand guidelines for customer communications.", role: "eCRM Designer", image: "/lovable-uploads/milo-profile.png", isComingSoon: false, ctaLabel: "Work with Milo", ctaAction: () => navigate("/milo-ecrm") },
