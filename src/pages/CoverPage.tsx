...
const CoverPage = () => {
  ...
  const crewProfiles: Record<string, CrewProfile> = {
    ...
    "rex": { description: "Automatically collects the latest global AI commerce & marketing news and generates Daily/Weekly/Monthly reports.\n\nKey capabilities: AI Trend · Daily Feed · Auto Report", role: "AI Commerce & Marketing Intelligence Reporter", image: "/lovable-uploads/crew-image-28.png", isComingSoon: false, ctaLabel: "Open Report", ctaAction: () => window.open("https://suno7608.github.io/ai-trend-hub/", "_blank") },
    "vera": { description: "Monitors VOC, promotions, and Chinese brand trends across 16 countries, delivering key market insights.\n\nKey capabilities: 16-Country · VOC Sensing · China Watch", role: "Global D2C Market Intelligence Analyst", image: "/lovable-uploads/crew-image-29.png", isComingSoon: false, ctaLabel: "Open Intel", ctaAction: () => window.open("https://suno7608.github.io/d2c-intel/", "_blank") },
  };
