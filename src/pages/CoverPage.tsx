  ...
  return <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-accent/5 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute bottom-12 left-0 w-full h-72 overflow-hidden pointer-events-none">
        <div className="flex animate-slide space-x-4" style={{width: 'calc(200% + 100px)'}}>
          ...
          <div className="flex space-x-4 min-w-max">
            ...
            {/* Video 10 - Violet video */}
            <div id="crew-video-10" className="w-40 h-60 bg-gradient-to-br from-violet-500/25 to-purple-500/25 rounded-3xl border border-white/15 backdrop-blur-sm overflow-hidden flex-shrink-0 shadow-lg">
              <video 
                className="w-full h-full object-cover rounded-3xl"
                autoPlay 
                loop 
            ...
            {/* Video 12 - Amber video */}
            <div id="crew-video-12" className="w-40 h-60 bg-gradient-to-br from-amber-500/25 to-orange-500/25 rounded-3xl border border-white/15 backdrop-blur-sm overflow-hidden flex-shrink-0 shadow-lg">
              <video 
                className="w-full h-full object-cover rounded-3xl"
                autoPlay 
                loop 
          ...
          <div className="flex space-x-4 min-w-max">
            ...
            {/* Video 10 - Violet video (duplicate) */}
            ...
            {/* Video 12 - Amber video (duplicate) */}
      ...
      <div className="text-center space-y-8 z-10 max-w-4xl mx-auto px-6 -mt-32">
        ...
        <div className="space-y-4">
          <h1 className="text-6xl md:text-7xl font-bold bg-gradient-to-b from-primary/60 via-primary/80 to-primary bg-clip-text text-transparent">
            Twin Crew
          </h1>
