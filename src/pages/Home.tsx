              ...
              <div className="overflow-x-auto">
                ...
                <div className="flex flex-col items-center space-y-6">
                  ...
                  <div className="relative w-96 h-8 mx-auto">
                    ...
                    {/* Horizontal line spanning all divisions */}
                  ...
                  <div className="flex items-start justify-center space-x-8 min-w-max">
                    ...
                    {/* Platform Division with D2C Leader above */}
                    <div className="flex flex-col items-center space-y-4">
                      {/* D2C Leader positioned above Platform */}
                      <div className="flex flex-col items-center space-y-2 mb-4">
                        ...
                        {/* Connecting line from D2C Leader to Platform */}
                        <div className="w-0.5 h-4 bg-muted-foreground/30"></div>
                      </div>
                      
                      {/* Platform Division Leader */}
