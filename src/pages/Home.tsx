          ...
          <Card className="p-8 bg-card/50 backdrop-blur-sm border-muted/20 shadow-lg max-w-6xl mx-auto">
            <div className="space-y-6">
              ...
              <div className="overflow-x-auto">
                <div className="flex items-start justify-center space-x-2 min-w-max px-8">
                  ...
                  {/* Marketing Division */}
                  <div className="relative bg-secondary/10 rounded-lg p-4 border-l-4 border-secondary animate-fade-in">
                  ...
                  {/* Vertical separator */}
                  <div className="w-px h-32 bg-muted-foreground/20 mt-8"></div>
                  
                  {/* Platform Division */}
                  <div className="relative bg-accent/10 rounded-lg p-4 border-l-4 border-accent animate-fade-in">
                    <div className="absolute -top-2 left-2 bg-accent text-accent-foreground text-xs px-2 py-1 rounded font-medium">
                      Platform
                    </div>
                    <div className="flex flex-col items-center space-y-4 pt-2">
                  ...
                  {/* Data Division */}
                  <div className="relative bg-muted/10 rounded-lg p-4 border-l-4 border-muted-foreground animate-fade-in">
                    <div className="absolute -top-2 left-2 bg-muted-foreground text-muted text-xs px-2 py-1 rounded font-medium">
                      Data
                    </div>
                    <div className="flex flex-col items-center space-y-4 pt-2">
                  ...
                  <div className="relative bg-green-50 rounded-lg p-4 border-l-4 border-green-600 animate-fade-in">
                  ...
                  <div className="relative bg-purple-50 rounded-lg p-4 border-l-4 border-purple-600 animate-fade-in">
