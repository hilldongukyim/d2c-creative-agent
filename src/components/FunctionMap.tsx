...
const FunctionMap: React.FC<FunctionMapProps> = ({
  ...
  const groups: Group[] = [{
    ...
    items: [{
      name: "Sam",
      role: "Data Analyst",
      imageSrc: "/lovable-uploads/d004c9d6-0491-459c-8639-7730374641aa.png"
    }]
  }, {
    title: "GEO",
    items: [{
      name: "Dan",
      role: "Geo Specialist",
      imageSrc: "/lovable-uploads/98c39541-6950-461b-a1b0-0247044ee38e.png"
    }]
  }, {
    title: "Intern",
    items: [{
        ...
        <div className="xl:col-span-3 md:col-span-2 bg-[hsl(var(--function-map-bg))] rounded-xl p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 grid-cols-4">
              ...
              {/* Promotion Team */}
              {groups.filter(group => group.title === "Promotion").map(group => <div key={group.title} className="bg-card border border-border/20 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow pointer-events-auto h-[640px]">
                  <header className="mb-4 pointer-events-none">
                    <h3 className="text-lg font-semibold text-foreground">{group.title}</h3>
                  </header>
                  {"sections" in group && <>
              ...
              <div className="space-y-4">
                {/* GEO Team */}
                {groups.filter(group => group.title === "GEO").map(group => <div key={group.title} className="bg-card border border-border/20 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow pointer-events-auto h-[280px]">
                    <header className="mb-4 pointer-events-none">
                      <h3 className="text-lg font-semibold text-foreground">{group.title}</h3>
                    </header>
                    <div className="flex justify-center pointer-events-none">
                ...
                {/* Data Team */}
                {groups.filter(group => group.title === "Data").map(group => <div key={group.title} className="bg-card border border-border/20 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow pointer-events-auto h-[280px]">
                    <header className="mb-4 pointer-events-none">
                      <h3 className="text-lg font-semibold text-foreground">{group.title}</h3>
                    </header>
                    <div className="flex justify-center pointer-events-none">
              ...
              {/* Intern Team */}
              {groups.filter(group => group.title === "Intern").map(group => <div key={group.title} className="bg-card border border-border/20 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow pointer-events-auto h-[420px]">
