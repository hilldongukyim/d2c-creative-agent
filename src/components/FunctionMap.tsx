...
const FunctionMap: React.FC<FunctionMapProps> = ({
  ...
  const groups: Group[] = [{
    ...
    items: [{
      ...
      name: "Theo",
      role: "Account Delete",
      imageSrc: "/lovable-uploads/2e6d7b60-abc9-4051-a585-fad42800aabb.png"
    }, {
      name: "Fiona",
      role: "Communication",
    ...
    sections: [{
      ...
      items: [{
        ...
        name: "Carmen",
        role: "Coordinator",
        imageSrc: "/lovable-uploads/c67db3d8-8cdc-426a-80e4-b8e7b6bf4604.png"
      }, {
        name: "Pip",
        role: "Designer",
        imageSrc: "/lovable-uploads/cf830101-de14-48d2-a5f5-23a3f692a0f0.png"
      }, {
        name: "Juno",
        role: "Criteo Variation",
        imageSrc: "/lovable-uploads/0984d14e-1c85-48e9-9be5-953e3bc72d9a.png"
      }, {
        name: "Luna",
        role: "DV360 Variation",
        imageSrc: "/lovable-uploads/09ed6890-8a71-43b1-9f99-2029d69c3e6c.png"
      }, {
        name: "Fern",
        role: "Other Variation",
        imageSrc: "/lovable-uploads/66fb2463-85b8-437c-9a16-afdb1c8b3861.png"
      }]
    }]
  }, {
    title: "Gallery Image",
    items: [{
      name: "Tango",
      role: "Gallery Resizing",
      imageSrc: "/lovable-uploads/c2f987d1-fdfb-4948-b854-092b9abd9f8c.png"
    }, {
      name: "Ben",
  ...
  return <section ref={containerRef} aria-label="Agent functions map" className="space-y-6">
      <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
        {groups.map(group => <article key={group.title} className="rounded-xl border bg-card p-5 shadow-sm">
            <header className="mb-4">
              <h3 className="text-lg font-semibold text-foreground">{group.title}</h3>
            </header>
            {"sections" in group ? <>
                {group.sections.map(section => <div key={section.subtitle} className="mb-5 last:mb-0">
                ...
                {group.items.map(item => <div key={`${group.title}-${item.name}`} data-profile-name={item.name.toLowerCase()} className="group flex flex-col items-center text-center cursor-pointer focus:outline-none focus:ring-2 focus:ring-ring rounded-md p-1" onClick={() => onProfileClick?.(item.name)} role="button" tabIndex={0}>
