                  ...
                  <>
                    {group.title === "Promotion" ? (
                      ...
                      <>
                        ...
                        {/* Analytics and Content Creation sections side by side */}
                        <div className="flex gap-4">
                          {group.sections.filter(section => section.subtitle !== "Team Leader").map((section) => (
                            <div key={section.subtitle} className="flex-1 pointer-events-auto">
                              <h4 className="mb-2 text-xs font-semibold uppercase tracking-wide text-muted-foreground pointer-events-none">
                                {section.subtitle}
                              </h4>
                      ...
                      // Regular layout for other teams
                      <>
                        {group.sections.map((section) => (
                          <div key={section.subtitle} className="mb-5 last:mb-0 pointer-events-auto">
                             {section.subtitle !== "Team Members" && section.subtitle !== "Team Leader" && (
                               <h4 className="mb-2 text-xs font-semibold uppercase tracking-wide text-muted-foreground pointer-events-none">
                                 {section.subtitle}
                               </h4>
                             )}
